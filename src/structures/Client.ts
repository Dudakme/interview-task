import { applicationCommand, CommandClient, Extension, ownerOnly } from "@pikokr/command.ts"
...
export class CustomizedCommandClient extends CommandClient {
  async setup() {
    ...
    await this.registry.loadAllModulesInDirectory(path.join(__dirname, "..", "modules"))
  }
}
